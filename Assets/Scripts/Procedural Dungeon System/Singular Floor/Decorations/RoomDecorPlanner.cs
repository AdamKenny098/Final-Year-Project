...
public class RoomDecorPlanner
{
    ...
    int GetTargetClusterCount(Room room)
    {
        ...
        if (area <= 150f)  return Random.Range(1, 2);
        if (area <= 250f)  return Random.Range(1, 2);
        if (area <= 400f)  return Random.Range(1, 3);
        if (area <= 600f)  return Random.Range(2, 4);
        if (area <= 800f)  return Random.Range(3, 5);
        if (area <= 1000f) return Random.Range(4, 6);
        if (area <= 1200f) return Random.Range(5, 7);
        if (area <= 1500f) return Random.Range(6, 9);
        if (area <= 1800f) return Random.Range(7, 10);
        if (area <= 2000f) return Random.Range(8, 12);
        if (area <= 2200f) return Random.Range(9, 13);
        if (area <= 2500f) return Random.Range(10, 14);
